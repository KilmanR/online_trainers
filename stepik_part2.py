...
# print('Напишите программу, которая считывает последовательность из 10 целых чисел и определяет, ' \
...
# print('На вход программе подаётся натуральное число n. Напишите программу вычисления знакочередующейся суммы:')
# n = int(input())
# for i in range(n):
#     s = ((-1) ** (n + 1)) * ((n + 1) // 2)
# print(s)

# print('Наибольшие числа 🌶️')
# print('''На вход программе подаются натуральное число n, 
...
# print('Последовательность Фибоначчи 🌶️')
# print('Напишите программу, которая считывает натуральное число n и выводит первые n чисел последовательности Фибоначчи.')
# a = 1
# y = 0
# n = int(input())
# for i in range (1, n + 1):
